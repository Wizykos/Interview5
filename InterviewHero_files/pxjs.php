(function jvxPixelWrapper(){
    ...
    var existingGroups = {"group1":["undefined"]};
    var pixelParams = {"GA_Client_ID":"103624318.1612219419","Trigger_Type":"page_view","Path_Segment_1":"undefined","Path_Segment_2":"undefined","Path_Segment_3":"undefined","px":"55fbe5792e1364","Content_Tags":"homePage,,,","us_privacy":"1-NN","Page_Language":"en","Login_ID":"undefined","Session_ID":"1612735585843.efdhm8r","Hit_Id":"2021-02-07T23:06:26.71+01:00","cData":"","ap_IDFA":"","ap_AAID":""};
    var gdprParams = "";
    var addnlPixelData = function getRetargetingData() {
   // refer to help link for more options
 return   [pixelParams.cData];
 };
    var partnerSyncPixels = {"Turbine_USA":"https://sync.jivox.com/tags/sync/usync.php?px=d9JvwTcL&src=re&id=55fbe5792e1364&&us_privacy=1-NN"};
